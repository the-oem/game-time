...
Bike.prototype.detectCollision = function (gamePiece, otherArray) {
...
Bike.prototype.draw = function (context, color, otherArray) { // loops
  let newGamePiece = new GamePiece(this.x, this.y, this.width, this.height);
  context.fillStyle = color;

  if (this.direction) {
    this.move();
    this.detectCollision(newGamePiece, otherArray);
