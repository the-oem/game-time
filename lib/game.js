...
function initializeGame() {
  ...
  let playerSize = 6;
  let p1StartX = canvas.width * .86 - playerSize / 2;
  let p2StartX = canvas.width * .16 - playerSize / 2;
  let p1StartY = canvas.height * .86 - playerSize / 2;
  let p2StartY = canvas.height * .16 - playerSize / 2;
